...
if (isset($_REQUEST['submit'])) {
    if (isset($_REQUEST['firstname']) && isset($_REQUEST['lastname']) && isset($_REQUEST['email']) && isset($_REQUEST['password']) && isset($_REQUEST['usertype']) && isset($_REQUEST['userstatus'])) {
        ...
        $sql = "INSERT INTO `login` (`firstname`, `lastname`, `email`, `password`, `usertype`, `userstatus`) VALUES ('$firstname', '$lastname', '$email', '$password', '$usertype', '$userstatus')";
        echo $sql . "<br>"; 
...
<body>
    ...
    <div class="container_fluid">
        ...
        <div class="radio-group">
            ...
            <label><input type="radio" name="userstatus" value="active" checked> Active</label>
            <label><input type="radio" name="userstatus" value="inactive"> Inactive</label>
        </div>
